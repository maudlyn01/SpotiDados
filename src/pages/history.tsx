...
export const History = () => {
    ...
    const nationalArtists = [
        { name: "Neyma", img: "./img/neyma.jpg" ,music:"Arromba"},
        { name: "Ubaka", img: "./img/ubakka.jpg" ,music:"Wene"},
        { name: "Edmazia", img: "./img/edmazia.jpg" ,music:"É Obra"},
        { name: "Perola", img: "./img/perola.jpg",music:"Sincera" },
    ];
    const internationalArtists = [
        { name: "Anderson Mario", img: "./img/Anderson-Mario.jpg" ,music:"Vai Dormir"},
        { name: "Anselmo", img: "./img/anselmo.png",music:"Tem Cuidado" },
        { name: "Levy", img: "./img/levy.jpg" ,music:"Madalena"},
        { name: "Rihanna", img: "./img/Rihanna.jpg" ,music:"Diamonds"},
    ];
